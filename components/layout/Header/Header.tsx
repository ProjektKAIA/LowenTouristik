        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-4">
            ...
            <a
              ...
              className="bg-secondary hover:bg-secondary/90 text-white p-3 rounded-full transition-all hover:scale-110"
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden mt-4 py-4 bg-white rounded-2xl shadow-xl">
            ...
            <div className="mt-4 px-4 pt-4 border-t border-neutral-cream">
              ...
              <a
                href={CONTACT.phone.href}
                className="flex items-center justify-center gap-2 bg-secondary hover:bg-secondary/90 text-white px-6 py-3 rounded-full font-bold transition-all"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path
                    strokeLinecap="round"

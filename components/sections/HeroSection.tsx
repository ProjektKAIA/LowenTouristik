      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6 text-center">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md border border-white/20 px-6 py-3 rounded-full mb-8 animate-fade-in">
            <svg className="w-5 h-5 text-secondary-ochre" fill="currentColor" viewBox="0 0 20 20">
              <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
            </svg>
            <span className="text-white font-medium">Über 2.500 zufriedene Afrika-Reisende</span>
          </div>
          ...
          {/* Subheadline */}
          <p 
            className="text-2xl md:text-4xl font-handwritten text-secondary-ochre mb-4 animate-fade-in-up" 
            style={{ animationDelay: '0.2s' }}
          >
            Über 2.500 Reisende verstehen jetzt, warum
          </p>
          ...
          >
            Authentische Begegnungen. Respektvolle Reisen. Maximal 12 Personen.
            <br />
            Jede Route von Agnes persönlich über 10× bereist.
          </p>
          ...
          >
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-black text-white mb-2">2.500+</div>
              <div className="text-sm text-white/80">Glückliche Reisende</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-black text-white mb-2">12</div>
              <div className="text-sm text-white/80">Max. Gruppengröße</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-black text-white mb-2">30+</div>
              <div className="text-sm text-white/80">Perfektionierte Routen</div>
            </div>
          </div>
        </div>
      </div>

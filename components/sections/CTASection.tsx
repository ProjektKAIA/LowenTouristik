        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-12 max-w-5xl mx-auto">
            ...
            >
              ...
              <div className="font-bold text-lg mb-2">{t('contact.phone.title')}</div>
              <div className="text-white/80 text-sm mb-2">{t('contact.phone.subtitle')}</div>
            ...
            >
              ...
              <div className="font-bold text-lg mb-2">{t('contact.whatsapp.title')}</div>
              <div className="text-white/80 text-sm mb-2">{t('contact.whatsapp.subtitle')}</div>
              <div className="text-secondary font-bold">{t('contact.whatsapp.cta')}</div>
            </a>
            ...
            >
              ...
              <div className="font-bold text-lg mb-2">{t('contact.email.title')}</div>
              <div className="text-white/80 text-sm mb-2">{t('contact.email.subtitle')}</div>
          ...
          <div className="bg-white/5 backdrop-blur-md border border-white/10 p-8 rounded-2xl inline-block mb-12">
            <div className="flex items-center gap-2 justify-center mb-2">
              ...
              <span className="font-bold">{t('office.title')}</span>
            </div>

        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 grid grid-cols-3 gap-6 max-w-2xl mx-auto animate-fadeInUp" style={{ animationDelay: '0.4s' }}>
            <div className="bg-white/10 backdrop-blur-md border border-white/20 p-6 rounded-2xl">
              <div className="text-4xl font-black text-secondary mb-2">{t('hero.stat1.value')}</div>
              <div className="text-sm text-white/80">{t('hero.stat1.label')}</div>
            </div>
            <div className="bg-white/10 backdrop-blur-md border border-white/20 p-6 rounded-2xl">
              <div className="text-4xl font-black text-secondary mb-2">{t('hero.stat2.value')}</div>
              <div className="text-sm text-white/80">{t('hero.stat2.label')}</div>
            </div>
            <div className="bg-white/10 backdrop-blur-md border border-white/20 p-6 rounded-2xl">
              <div className="text-4xl font-black text-secondary mb-2">{t('hero.stat3.value')}</div>
              <div className="text-sm text-white/80">{t('hero.stat3.label')}</div>
            </div>
          </div>
        </div>
      </div>

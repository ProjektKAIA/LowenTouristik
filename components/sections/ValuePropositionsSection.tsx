    ...
    <section id="werte" className="py-24 bg-neutral-cream">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="max-w-4xl mx-auto text-center mb-16">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif font-black text-primary mb-6">
            {title}
          </h2>
          <p className="text-lg md:text-xl text-neutral-brown/80 leading-relaxed">
            {subtitle}
          </p>
        </div>
                ...
                <div className="p-6 bg-neutral-cream/50 border-b border-neutral-cream">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="font-bold text-neutral-brown">
                      {comparison.standardTitle}
                    </h3>
                  </div>
                  <p className="text-neutral-brown/70 text-sm">
                    {comparison.standardDescription}
                  </p>
                </div>
                ...
                <div className="p-6 bg-white">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="font-bold text-primary">
                      {comparison.oursTitle}
                    </h3>
                  </div>
                  <p className="text-neutral-brown/80">
                    {comparison.oursDescription}
                  </p>
                </div>
              </div>
            ))}
        ...
        {badge && (
          <div className="text-center">
            <div className="inline-flex items-center gap-2 bg-white px-6 py-3 rounded-full shadow-md">
              ...
              <span className="text-sm font-medium text-neutral-brown">
                {badge}
              </span>
            </div>
          </div>
